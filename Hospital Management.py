...
def about_window():
    ...
    details_2 = str(
            "This project is created by Raj gupta " + 
            "as part of their MCA(INTEGRATED) year 6th sem. project 2022 - 2023, under " +
            "the able and very helpful guidance of Mrs. AMIT KOHLI, " + 
            "Raja Balwant Singh Managment Technical Campus khandari , Agra. All codes in this file " +
            "is completely written by Raj gupta. "
        )
    ...
    #img3 = Image.open(r"Data\\Images\\Profile Pics\\Faizan.jpg")
    #img1 = Image.open(r"Data\\Images\\Profile Pics\\Abhinav.jpg")
    #img2 = Image.open(r"Data\\Images\\Profile Pics\\Aditya.jpg")
    ...
    about_title_lucifer = Label(right_frame, text = "Abhinav verma", 
                    font = "evogria 16", anchor = CENTER, bg = "#FFE2E2")
    about_title_lucifer.grid(row = 12, column = 0, padx = 70, sticky = W)

    about_title_vats = Label(right_frame, text = "Aditya kumar singh", 
                    font = "evogria 16", anchor = CENTER, bg = "#FFE2E2")
    about_title_vats.grid(row = 12, column = 0, padx = 5)

    about_title_meena_sir = Label(right_frame, text = "Faizan ahamad bhatt", font = "evogria 16", anchor = CENTER,
                                  bg = "#FFE2E2")
